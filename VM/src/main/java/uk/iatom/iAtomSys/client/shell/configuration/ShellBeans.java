...
public class ShellBeans {
  ...
  /**
   * Create a {@link ShellApplicationRunner} controlled by me in an attempt to get rid of rogue
   * error messages polluting the UI, including when Spring Shell tries to parse 'help -1' and
   * thinks '-1' is a switch.
   *
   * @param shellRunners
   * @return
   */
