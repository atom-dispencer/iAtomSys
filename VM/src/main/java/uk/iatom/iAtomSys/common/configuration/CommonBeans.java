...
public class CommonBeans {
  ...
  public InstructionSet instructionSet() throws DuplicateInstructionException {
    ...
    set.createInstruction("NOP", (byte) 0x00, InstructionDisassembler::noFlags,
        InstructionExecutor::xNOP);
    set.createInstruction("MOV", (byte) 0x01, InstructionDisassembler::twoRegisters_02_35,
        InstructionExecutor::xMOV);
    set.createInstruction("FLG", (byte) 0x02, InstructionDisassembler::dFLG,
        InstructionExecutor::xFLG);
    set.createInstruction("PSH", (byte) 0x04, InstructionDisassembler::oneRegister_02,
        InstructionExecutor::xPSH);
    set.createInstruction("POP", (byte) 0x05, InstructionDisassembler::oneRegister_02,
        InstructionExecutor::xPOP);
    set.createInstruction("INC", (byte) 0x06, InstructionDisassembler::oneRegister_02,
        InstructionExecutor::xINC);
    set.createInstruction("DEC", (byte) 0x07, InstructionDisassembler::oneRegister_02,
        InstructionExecutor::xDEC);
    set.createInstruction("ADD", (byte) 0x08, InstructionDisassembler::oneRegister_02,
        InstructionExecutor::xADD);
    set.createInstruction("SUB", (byte) 0x09, InstructionDisassembler::oneRegister_02,
